# Sprint_16 — Diário de bordo

**Milestone:** Pós-M6 (opcional) — URI scheme, instância única, OpenSubtitles
**Planning:** ver `Sprint_Planning_16.md`
**Início:** (preencher)
**Fim:** (preencher)
...
## Desvios face ao Sprint_Planning_16.md

# Sprint_13 — Diário de bordo

**Milestone:** M5b (parte 3) — Resiliência de rede e disclosure cloud/local
**Planning:** ver `Sprint_Planning_13.md`
**Início:** (preencher)
**Fim:** (preencher)
...
## Desvios face ao Sprint_Planning_13.md

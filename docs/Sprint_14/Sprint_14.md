# Sprint_14 — Diário de bordo

**Milestone:** M5b (parte 4) — Testes automatizados (mockado + anti-leak)
**Planning:** ver `Sprint_Planning_14.md`
**Início:** (preencher)
**Fim:** (preencher)
...
## Desvios face ao Sprint_Planning_14.md

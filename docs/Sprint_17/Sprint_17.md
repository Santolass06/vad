# Sprint_17 — Diário de bordo

**Milestone:** M7 — Conformidade legal (licenças, privacidade, distribuição)
**Planning:** ver `Sprint_Planning_17.md`
**Início:** (preencher)
**Fim:** (preencher)
...
## Desvios face ao Sprint_Planning_17.md
